...
if not df.empty:
    ...
    # convertir la superficie en numerique et filtrer les valaurs nulles 
...
app.layout = dbc.Container(fluid=True, children=[
    ...
    dbc.Row([
        dbc.Col([
            html.H4("Filtres", className="mt-4"),
            html.Hr(),
        ...
        ], width=3, style={"backgroundColor": "#f8f9fa", "padding": "20px", "height": "100%"}),
        ...
        dbc.Col([
            ...
            dbc.Row([
                ...
                dbc.Col(dbc.Card([
                    dbc.CardBody([
                        html.H6("Prix moyen au m² à vendre", className="card-subtitle"),
                        html.H3(
